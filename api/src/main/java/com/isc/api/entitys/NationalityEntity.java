...
@Entity
@Table(name = "nationality", schema = "administration", uniqueConstraints = {
...
public class NationalityEntity {
	...
	@SequenceGenerator(name = "nationality_id_seq", sequenceName = "administration.nationality_id_seq", allocationSize = 1)
	private Integer id;
