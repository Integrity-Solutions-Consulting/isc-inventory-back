...
public class EmployeeController {
	...
	@PostMapping("/save")
	public ResponseEntity<ResponseDto<EmployeeTableResponseDTO>> save(@RequestBody EmployeeRequestDTO request) {
		return ResponseEntity.ok(service.save(request));
	}

	@PutMapping("/update/{id}")
	public ResponseEntity<ResponseDto<EmployeeTableResponseDTO>> update(@RequestBody EmployeeRequestDTO request,
