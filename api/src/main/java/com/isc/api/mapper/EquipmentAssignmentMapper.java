...
public class EquipmentAssignmentMapper {
    ...
    public static EquipmentAssignmentDetailResponseDTO toDetailDTO(EquipmentAssignmentEntity entity) {
        ...
        if (entity.getEquipment().getCondition() != null) {
            condition = new EquipmentConditionResponseDTO();
            condition.setId(entity.getEquipment().getCondition().getId());
            condition.setName(entity.getEquipment().getCondition().getName());
        }
