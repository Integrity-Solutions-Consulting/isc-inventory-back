...
@Entity
@Table(name = "\"position\"", schema = "administration", uniqueConstraints = {
...
public class PositionEntity {
	...
	@SequenceGenerator(name = "position_id_seq", sequenceName = "administration.position_id_seq", allocationSize = 1)
	private Integer id;
